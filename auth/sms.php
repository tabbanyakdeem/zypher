...
<a href="/signout" class="authLinks signupBasicHeader onboarding-header" data-uia="header-signout-link">Sign out</a>
</div>
...
<h1 class="stepTitle" data-uia="stepTitle">Enter your code</h1>
</div>
</div>
<div id="" class="contextBody contextRow" data-uia="contextBody">Enter the one-time code sent to +44**** - *** - *** to confirm your account and start your membership.</div>
...
<input name="signupOtpCode" class="nfTextField" type="tel" autocomplete="off" maxlength="10" minlength="6" dir="" placeholder="" value="" required>
</label>
</div>
</div>
</li>
...
<button type="submit" autocomplete="off" tabindex="0" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" data-uia="submitBtn" placeholder="">Start Membership</button>
</form>
</div>
<div class="otpCodeEntryLinks">
<div class="">
<p class="resend-codes" data-uia="resend-codes">
<a class="resend-link" data-uia="resend-link-code" href="#">text me again</a>
</p>
<p>
<a class="change-phone" data-uia="change-phone" href="cc.php">Use a different payment method</a>
</p>
</div>
</div>
</div>
